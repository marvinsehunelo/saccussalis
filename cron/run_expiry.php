<?php
// cron/run_expiry.php - SaccusSalis' scheduled expiry, for a Railway cron service.
// Railway has no crontab: schedule this service (e.g. every 5 minutes) with
//   start command: php cron/run_expiry.php
// Order matters: codes die before the money behind them is released.
foreach (['expire_codes.php', 'expire_holds.php', 'retry_vouchmorph_notifications.php'] as $job) {
