<?php
// saccussalis/backend/api/v1/settlement/check.php
// VouchMorph settlement check for SaccusSalis (see settlement_desk.php). Certificate required.
...
try {
    echo json_encode(saccussalis_desk($pdo)->check($input));
} catch (Throwable $e) {
